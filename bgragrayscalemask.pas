...
uses
  Classes, SysUtils, BGRATypes,{$IFNDEF FPC}Types, GraphType, BGRAGraphics, {$ENDIF} BGRABitmapTypes;
...
procedure DownSamplePutImageGrayscale(sourceData: PByte; sourcePixelSize: BGRANativeInt; sourceRowDelta: BGRANativeInt; sourceWidth, sourceHeight: BGRANativeInt; dest: TGrayscaleMask; ADestRect: TRect); overload;
...
begin
  ...
  result := FData + BGRANativeInt(Y)*BGRANativeInt(FWidth);
end;
...
procedure DownSamplePutImageGrayscale(sourceData: PByte;
  sourcePixelSize: BGRANativeInt; sourceRowDelta: BGRANativeInt; sourceWidth,
  sourceHeight: BGRANativeInt; dest: TGrayscaleMask; ADestRect: TRect);
var
  x_dest,y_dest: integer;
  pdest: PByte;
  nbPix,sum: BGRANativeUInt;
  prev_x_src,x_src,x_src_nb,xb: BGRANativeInt;
  x_src_inc,x_src_acc,x_src_div,x_src_rest: BGRANativeInt;
  prev_y_src,y_src,y_src_nb,yb: BGRANativeInt;
  y_src_inc,y_src_acc,y_src_div,y_src_rest: BGRANativeInt;
