...
uses
  SysUtils, dynlibs, types, classes,
  Windows;
...
var
  ...
  glLightiv: procedure(light, pname: GLenum; const params: PGLint); stdcall;
  ...
  glPixelMapfv: procedure(map: GLenum; mapsize: GLint; const values: PGLfloat); stdcall;
  glPixelMapuiv: procedure(map: GLenum; mapsize: GLint; const values: PGLuint); stdcall;
  glPixelMapusv: procedure(map: GLenum; mapsize: GLint; const values: PGLushort); stdcall;
  ...
  glTexImage1D: procedure(target: GLenum; level: GLInt; internalformat: GLEnum; width: GLsizei; border: GLint; format, atype: GLenum; const pixels: Pointer); stdcall;
  glTexImage2D: procedure(target: GLenum; level: GLInt; internalformat: GLEnum; width, height: GLsizei; border: GLint; format, atype: GLenum; const pixels: Pointer); stdcall;
...
function WinChoosePixelFormat(DC: HDC; p2: PPixelFormatDescriptor): Integer; stdcall; external 'gdi32' name 'ChoosePixelFormat';
