...
uses classes, FPCanvas, FPimage, Types;

procedure DrawSolidLine (Canv : TFPCustomCanvas; x1,y1, x2,y2:integer; const color:TFPColor); overload;
procedure DrawPatternLine (Canv:TFPCustomCanvas; x1,y1, x2,y2:integer; Pattern:TPenPattern; const color:TFPColor); overload;
procedure FillRectangleColor (Canv:TFPCustomCanvas; x1,y1, x2,y2:integer; const color:TFPColor); overload;
procedure FillRectanglePattern (Canv:TFPCustomCanvas; x1,y1, x2,y2:integer; const pattern:TBrushPattern; const color:TFPColor); overload;
procedure FillRectangleHashHorizontal (Canv:TFPCustomCanvas; const rect:TRect; width:integer; const c:TFPColor); overload;
procedure FillRectangleHashVertical (Canv:TFPCustomCanvas; const rect:TRect; width:integer; const c:TFPColor); overload;
procedure FillRectangleHashDiagonal (Canv:TFPCustomCanvas; const rect:TRect; width:integer; const c:TFPColor); overload;
procedure FillRectangleHashBackDiagonal (Canv:TFPCustomCanvas; const rect:TRect; width:integer; const c:TFPColor); overload;
procedure FillFloodColor (Canv:TFPCustomCanvas; x,y:integer; const color:TFPColor); overload;
procedure FillFloodPattern (Canv:TFPCustomCanvas; x,y:integer; const pattern:TBrushPattern; const color:TFPColor); overload;
procedure FillFloodHashHorizontal (Canv:TFPCustomCanvas; x,y:integer; width:integer; const c:TFPColor); overload;
procedure FillFloodHashVertical (Canv:TFPCustomCanvas; x,y:integer; width:integer; const c:TFPColor); overload;
procedure FillFloodHashDiagonal (Canv:TFPCustomCanvas; x,y:integer; width:integer; const c:TFPColor); overload;
procedure FillFloodHashBackDiagonal (Canv:TFPCustomCanvas; x,y:integer; width:integer; const c:TFPColor); overload;
procedure FillFloodHashDiagCross (Canv:TFPCustomCanvas; x,y:integer; width:integer; const c:TFPColor); overload;
procedure FillFloodHashCross (Canv:TFPCustomCanvas; x,y:integer; width:integer; const c:TFPColor); overload;

procedure DrawSolidLine (Canv : TFPCustomCanvas; x1,y1, x2,y2:integer); overload;
procedure DrawPatternLine (Canv:TFPCustomCanvas; x1,y1, x2,y2:integer; Pattern:TPenPattern); overload;
procedure FillRectanglePattern (Canv:TFPCustomCanvas; x1,y1, x2,y2:integer; const pattern:TBrushPattern); overload;
procedure FillRectangleColor (Canv:TFPCustomCanvas; x1,y1, x2,y2:integer); overload;
procedure FillRectangleHashHorizontal (Canv:TFPCustomCanvas; const rect:TRect; width:integer); overload;
procedure FillRectangleHashVertical (Canv:TFPCustomCanvas; const rect:TRect; width:integer); overload;
procedure FillRectangleHashDiagonal (Canv:TFPCustomCanvas; const rect:TRect; width:integer); overload;
procedure FillRectangleHashBackDiagonal (Canv:TFPCustomCanvas; const rect:TRect; width:integer); overload;
procedure FillFloodColor (Canv:TFPCustomCanvas; x,y:integer); overload;
procedure FillFloodPattern (Canv:TFPCustomCanvas; x,y:integer; const pattern:TBrushPattern); overload;
procedure FillFloodHashHorizontal (Canv:TFPCustomCanvas; x,y:integer; width:integer); overload;
procedure FillFloodHashVertical (Canv:TFPCustomCanvas; x,y:integer; width:integer); overload;
procedure FillFloodHashDiagonal (Canv:TFPCustomCanvas; x,y:integer; width:integer); overload;
procedure FillFloodHashBackDiagonal (Canv:TFPCustomCanvas; x,y:integer; width:integer); overload;
procedure FillFloodHashDiagCross (Canv:TFPCustomCanvas; x,y:integer; width:integer); overload;
procedure FillFloodHashCross (Canv:TFPCustomCanvas; x,y:integer; width:integer); overload;
