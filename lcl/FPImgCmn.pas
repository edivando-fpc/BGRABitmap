...
function Swap(This : int64): int64; overload;
function Swap(This : Longword): longword; overload;
function Swap(This : integer): integer; overload;
function Swap(This : Word): Word; overload;
function CalculateCRC (var data; alength:integer) : longword; overload;
function CalculateCRC (CRC:longword; var data; alength:integer) : longword; overload;
