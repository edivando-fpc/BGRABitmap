...
var
  ...
  glDrawRangeElements: procedure(mode: GLenum; start: GLuint; _end: GLuint; count: GLsizei; _type: GLenum; const indices: PGLvoid); stdcall;
  glColorTable: procedure(target: GLenum; internalformat: GLenum; width: GLsizei; format: GLenum; _type: GLenum; const table: PGLvoid); stdcall;
  ...
  glGetColorTable: procedure(target: GLenum; format: GLenum; _type: GLenum; table: PGLvoid); stdcall;
  ...
  glColorSubTable: procedure(target: GLenum; start: GLsizei; count: GLsizei; format: GLenum; _type: GLenum; const data: PGLvoid); stdcall;
  glCopyColorSubTable: procedure(target: GLenum; start: GLsizei; x: GLint; y: GLint; width: GLsizei); stdcall;
  glConvolutionFilter1D: procedure(target: GLenum; internalformat: GLenum; width: GLsizei; format: GLenum; _type: GLenum; const image: PGLvoid); stdcall;
  glConvolutionFilter2D: procedure(target: GLenum; internalformat: GLenum; width: GLsizei; height: GLsizei; format: GLenum; _type: GLenum; const image: PGLvoid); stdcall;
  ...
  glGetConvolutionFilter: procedure(target: GLenum; format: GLenum; _type: GLenum; image: PGLvoid); stdcall;
  ...
  glGetSeparableFilter: procedure(target: GLenum; format: GLenum; _type: GLenum; row: PGLvoid; column: PGLvoid; span: PGLvoid); stdcall;
  glSeparableFilter2D: procedure(target: GLenum; internalformat: GLenum; width: GLsizei; height: GLsizei; format: GLenum; _type: GLenum; const row: PGLvoid; const column: PGLvoid); stdcall;
  glGetHistogram: procedure(target: GLenum; reset: GLboolean; format: GLenum; _type: GLenum; values: PGLvoid); stdcall;
  ...
  glGetMinmax: procedure(target: GLenum; reset: GLboolean; format: GLenum; _type: GLenum; values: PGLvoid); stdcall;
  ...
  glTexImage3D: procedure(target: GLenum; level: GLint; internalformat: GLint; width: GLsizei; height: GLsizei; depth: GLsizei; border: GLint; format: GLenum; _type: GLenum; const pixels: PGLvoid); stdcall;
  glTexSubImage3D: procedure(target: GLenum; level: GLint; xoffset: GLint; yoffset: GLint; zoffset: GLint; width: GLsizei; height: GLsizei; depth: GLsizei; format: GLenum; _type: GLenum; const pixels: PGLvoid); stdcall;
...
var
  ...
  glCompressedTexSubImage3D: procedure(target: GLenum; level: GLint; xoffset: GLint; yoffset: GLint; zoffset: GLint; width: GLsizei; height: GLsizei; depth: GLsizei; format: GLenum; imageSize: GLsizei; const data: PGLvoid); stdcall;
  glCompressedTexSubImage2D: procedure(target: GLenum; level: GLint; xoffset: GLint; yoffset: GLint; width: GLsizei; height: GLsizei; format: GLenum; imageSize: GLsizei; const data: PGLvoid); stdcall;
  glCompressedTexSubImage1D: procedure(target: GLenum; level: GLint; xoffset: GLint; width: GLsizei; format: GLenum; imageSize: GLsizei; const data: PGLvoid); stdcall;
  glGetCompressedTexImage: procedure(target: GLenum; level: GLint; img: PGLvoid); stdcall;
...
var
  ...
  wglSaveBufferRegionARB: function(hRegion: THandle; x: GLint; y: GLint; width: GLint; height: GLint): BOOL; stdcall;
  wglRestoreBufferRegionARB: function(hRegion: THandle; x: GLint; y: GLint; width: GLint; height: GLint; xSrc: GLint; ySrc: GLint): BOOL; stdcall;
...
var
  glCompressedTexImage3DARB: procedure(target: GLenum; level: GLint; internalformat: GLenum; width: GLsizei; height: GLsizei; depth: GLsizei; border: GLint; imageSize: GLsizei; const data: PGLvoid); stdcall;
  ...
  glCompressedTexImage1DARB: procedure(target: GLenum; level: GLint; internalformat: GLenum; width: GLsizei; border: GLint; imageSize: GLsizei; const data: PGLvoid); stdcall;
  glCompressedTexSubImage3DARB: procedure(target: GLenum; level: GLint; xoffset: GLint; yoffset: GLint; zoffset: GLint; width: GLsizei; height: GLsizei; depth: GLsizei; format: GLenum; imageSize: GLsizei; const data: PGLvoid); stdcall;
  glCompressedTexSubImage2DARB: procedure(target: GLenum; level: GLint; xoffset: GLint; yoffset: GLint; width: GLsizei; height: GLsizei; format: GLenum; imageSize: GLsizei; const data: PGLvoid); stdcall;
  glCompressedTexSubImage1DARB: procedure(target: GLenum; level: GLint; xoffset: GLint; width: GLsizei; format: GLenum; imageSize: GLsizei; const data: PGLvoid); stdcall;
  glGetCompressedTexImageARB: procedure(target: GLenum; lod: GLint; img: PGLvoid); stdcall;
...
var
  glWeightbvARB: procedure(size: GLint; weights: PGLbyte); stdcall;
  glWeightsvARB: procedure(size: GLint; weights: PGLshort); stdcall;
  glWeightivARB: procedure(size: GLint; weights: PGLint); stdcall;
  glWeightfvARB: procedure(size: GLint; weights: PGLfloat); stdcall;
  glWeightdvARB: procedure(size: GLint; weights: PGLdouble); stdcall;
  glWeightvARB: procedure(size: GLint; weights: PGLdouble); stdcall;
  glWeightubvARB: procedure(size: GLint; weights: PGLubyte); stdcall;
  glWeightusvARB: procedure(size: GLint; weights: PGLushort); stdcall;
  glWeightuivARB: procedure(size: GLint; weights: PGLuint); stdcall;
  glWeightPointerARB: procedure(size: GLint; _type: GLenum; stride: GLsizei; pointer: PGLvoid); stdcall;
...
var
  ...
  glVertexAttribPointerARB: procedure(index: GLuint; size: GLint; _type: GLenum; normalized: GLboolean; stride: GLsizei; const pointer: PGLvoid); stdcall;
  glEnableVertexAttribArrayARB: procedure(index: GLuint); stdcall;
  glDisableVertexAttribArrayARB: procedure(index: GLuint); stdcall;
  glProgramStringARB: procedure(target: GLenum; format: GLenum; len: GLsizei; const _string: PGLvoid); stdcall;
  ...
  glGetProgramStringARB: procedure(target: GLenum; pname: GLenum; _string: PGLvoid); stdcall;
  ...
  glGetVertexAttribPointervARB: procedure(index: GLuint; pname: GLenum; pointer: PGLvoid); stdcall;
...
var
  ...
  glWindowPos2dvARB: procedure(const p: PGLdouble); stdcall;
  glWindowPos2fvARB: procedure(const p: PGLfloat); stdcall;
  glWindowPos2ivARB: procedure(const p: PGLint); stdcall;
  glWindowPos2svARB: procedure(const p: PGLshort); stdcall;
  ...
  glWindowPos3dvARB: procedure(const p: PGLdouble); stdcall;
  glWindowPos3fvARB: procedure(const p: PGLfloat); stdcall;
  glWindowPos3ivARB: procedure(const p: PGLint); stdcall;
  glWindowPos3svARB: procedure(const p: PGLshort); stdcall;
...
var
  glColorSubTableEXT: procedure(target: GLenum; start: GLsizei; count: GLsizei; format: GLenum; _type: GLenum; const data: PGLvoid); stdcall;
...
var
  glConvolutionFilter1DEXT: procedure(target: GLenum; internalformat: GLenum; width: GLsizei; format: GLenum; _type: GLenum; const image: PGLvoid); stdcall;
  glConvolutionFilter2DEXT: procedure(target: GLenum; internalformat: GLenum; width: GLsizei; height: GLsizei; format: GLenum; _type: GLenum; const image: PGLvoid); stdcall;
  ...
  glGetConvolutionFilterEXT: procedure(target: GLenum; format: GLenum; _type: GLenum; image: PGLvoid); stdcall;
  glSeparableFilter2DEXT: procedure(target: GLenum; internalformat: GLenum; width: GLsizei; height: GLsizei; format: GLenum; _type: GLenum; const row: PGLvoid; const column: PGLvoid); stdcall;
  glGetSeparableFilterEXT: procedure(target: GLenum; format: GLenum; _type: GLenum; row: PGLvoid; column: PGLvoid; span: PGLvoid); stdcall;
  glConvolutionParameteriEXT: procedure(target: GLenum; pname: GLenum; param: GLint); stdcall;
  glConvolutionParameterivEXT: procedure(target: GLenum; pname: GLenum; const params: PGLint); stdcall;
  glConvolutionParameterfEXT: procedure(target: GLenum; pname: GLenum; param: GLfloat); stdcall;
...
var
  ...
  glFogCoordPointerEXT: procedure(_type: GLenum; stride: GLsizei; pointer: PGLvoid); stdcall;
...
var
  ...
  glGetHistogramEXT: procedure(target: GLenum; reset: GLboolean; format: GLenum; _type: GLenum; values: PGLvoid); stdcall;
  ...
  glGetMinmaxEXT: procedure(target: GLenum; reset: GLboolean; format: GLenum; _type: GLenum; values: PGLvoid); stdcall;
...
var
  ...
  glMultiDrawElementsEXT: procedure(mode: GLenum; count: PGLsizei; _type: GLenum; const indices: PGLvoid; primcount: GLsizei); stdcall;
...
const
  ...
  // GL_TEXTURE_CUBE_MAP_ARB  { already defined }
var
  glColorTableEXT: procedure(target: GLenum; internalFormat: GLenum; width: GLsizei; format: GLenum; _type: GLenum; const data: PGLvoid); stdcall;
  // glColorSubTableEXT  { already defined }
  glGetColorTableEXT: procedure(target: GLenum; format: GLenum; _type: GLenum; data: PGLvoid); stdcall;
...
var
  glSecondaryColor3bEXT: procedure(components: GLbyte); stdcall;
  glSecondaryColor3sEXT: procedure(components: GLshort); stdcall;
  glSecondaryColor3iEXT: procedure(components: GLint); stdcall;
  glSecondaryColor3fEXT: procedure(components: GLfloat); stdcall;
  glSecondaryColor3dEXT: procedure(components: GLdouble); stdcall;
  glSecondaryColor3ubEXT: procedure(components: GLubyte); stdcall;
  glSecondaryColor3usEXT: procedure(components: GLushort); stdcall;
  glSecondaryColor3uiEXT: procedure(components: GLuint); stdcall;
  glSecondaryColor3bvEXT: procedure(components: GLbyte); stdcall;
  glSecondaryColor3svEXT: procedure(components: GLshort); stdcall;
  glSecondaryColor3ivEXT: procedure(components: GLint); stdcall;
  glSecondaryColor3fvEXT: procedure(components: GLfloat); stdcall;
  glSecondaryColor3dvEXT: procedure(components: GLdouble); stdcall;
  glSecondaryColor3ubvEXT: procedure(components: GLubyte); stdcall;
  glSecondaryColor3usvEXT: procedure(components: GLushort); stdcall;
  glSecondaryColor3uivEXT: procedure(components: GLuint); stdcall;
  glSecondaryColorPointerEXT: procedure(size: GLint; _type: GLenum; stride: GLsizei; pointer: PGLvoid); stdcall;
...
//***** GL_EXT_subtexture *****//
var
  glTexSubImage1DEXT: procedure(target: GLenum; level: GLint; xoffset: GLint; width: GLsizei; format: GLenum; _type: GLenum; const pixels: PGLvoid); stdcall;
  glTexSubImage2DEXT: procedure(target: GLenum; level: GLint; xoffset: GLint; yoffset: GLint; width: GLsizei; height: GLsizei; format: GLenum; _type: GLenum; const pixels: PGLvoid); stdcall;
  glTexSubImage3DEXT: procedure(target: GLenum; level: GLint; xoffset: GLint; yoffset: GLint; zoffset: GLint; width: GLsizei; height: GLsizei; depth: GLsizei; format: GLenum; _type: GLenum; const pixels: PGLvoid); stdcall;
...
var
  glTexImage3DEXT: procedure(target: GLenum; level: GLint; internalformat: GLenum; width: GLsizei; height: GLsizei; depth: GLsizei; border: GLint; format: GLenum; _type: GLenum; const pixels: PGLvoid); stdcall;
...
var
  ...
  glVertexPointerEXT: procedure(size: GLint; _type: GLenum; stride: GLsizei; count: GLsizei; const pointer: PGLvoid); stdcall;
  glNormalPointerEXT: procedure(_type: GLenum; stride: GLsizei; count: GLsizei; const pointer: PGLvoid); stdcall;
  glColorPointerEXT: procedure(size: GLint; _type: GLenum; stride: GLsizei; count: GLsizei; const pointer: PGLvoid); stdcall;
  glIndexPointerEXT: procedure(_type: GLenum; stride: GLsizei; count: GLsizei; const pointer: PGLvoid); stdcall;
  glTexCoordPointerEXT: procedure(size: GLint; _type: GLenum; stride: GLsizei; count: GLsizei; const pointer: PGLvoid); stdcall;
  glEdgeFlagPointerEXT: procedure(stride: GLsizei; count: GLsizei; const pointer: PGLboolean); stdcall;
  glGetPointervEXT: procedure(pname: GLenum; params: PGLvoid); stdcall;
...
var
  ...
  glSetInvariantEXT: procedure(id: GLuint; _type: GLenum; addr: PGLvoid); stdcall;
  glSetLocalConstantEXT: procedure(id: GLuint; _type: GLenum; addr: PGLvoid); stdcall;
  glVariantbvEXT: procedure(id: GLuint; addr: PGLbyte); stdcall;
  glVariantsvEXT: procedure(id: GLuint; addr: PGLshort); stdcall;
  glVariantivEXT: procedure(id: GLuint; addr: PGLint); stdcall;
  glVariantfvEXT: procedure(id: GLuint; addr: PGLfloat); stdcall;
  glVariantdvEXT: procedure(id: GLuint; addr: PGLdouble); stdcall;
  glVariantubvEXT: procedure(id: GLuint; addr: PGLubyte); stdcall;
  glVariantusvEXT: procedure(id: GLuint; addr: PGLushort); stdcall;
  glVariantuivEXT: procedure(id: GLuint; addr: PGLuint); stdcall;
  glVariantPointerEXT: procedure(id: GLuint; _type: GLenum; stride: GLuint; addr: PGLvoid); stdcall;
  ...
  glGetVariantPointervEXT: procedure(id: GLuint; value: GLenum; data: PGLvoid); stdcall;
...
var
  ...
  glVertexWeightPointerEXT: procedure(size: GLint; _type: GLenum; stride: GLsizei; pointer: PGLvoid); stdcall;
...
var
  glMapControlPointsNV: procedure(target: GLenum; index: GLuint; _type: GLenum; ustride: GLsizei; vstride: GLsizei; uorder: GLint; vorder: GLint; _packed: GLboolean; const points: PGLvoid); stdcall;
  ...
  glGetMapControlPointsNV: procedure(target: GLenum; index: GLuint; _type: GLenum; ustride: GLsizei; vstride: GLsizei; _packed: GLboolean; points: PGLvoid); stdcall;
...
var
  glVertexArrayRangeNV: procedure(length: GLsizei; pointer: PGLvoid); stdcall;
  glFlushVertexArrayRangeNV: procedure(); stdcall;
{$IFDEF Windows}
  wglAllocateMemoryNV: function(size: GLsizei; readFrequency: GLfloat; writeFrequency: GLfloat; priority: GLfloat): PGLvoid; stdcall;
  wglFreeMemoryNV: procedure(pointer: PGLvoid); stdcall;
{$ENDIF}
...
var
  ...
  glDeleteProgramsNV: procedure(n: GLsizei; const ids: PGLuint); stdcall;
  glExecuteProgramNV: procedure(target: GLenum; id: GLuint; const params: PGLfloat); stdcall;
  glGenProgramsNV: procedure(n: GLsizei; ids: PGLuint); stdcall;
  glAreProgramsResidentNV: function(n: GLsizei; const ids: PGLuint; residences: PGLboolean): GLboolean; stdcall;
  glRequestResidentProgramsNV: procedure(n: GLsizei; ids: PGLuint); stdcall;
  ...
  glGetVertexAttribPointervNV: procedure(index: GLuint; pname: GLenum; pointer: PGLvoid); stdcall;
  ...
  glProgramParameter4fvNV: procedure(target: GLenum; index: GLuint; const params: PGLfloat); stdcall;
  glProgramParameters4dvNV: procedure(target: GLenum; index: GLuint; num: GLuint; const params: PGLdouble); stdcall;
  glProgramParameters4fvNV: procedure(target: GLenum; index: GLuint; num: GLuint; const params: PGLfloat); stdcall;
  glTrackMatrixNV: procedure(target: GLenum; address: GLuint; matrix: GLenum; transform: GLenum); stdcall;
  glVertexAttribPointerNV: procedure(index: GLuint; size: GLint; _type: GLenum; stride: GLsizei; const pointer: PGLvoid); stdcall;
  ...
  glVertexAttribs1svNV: procedure(index: GLuint; n: GLsizei; const v: PGLshort); stdcall;
  glVertexAttribs1fvNV: procedure(index: GLuint; n: GLsizei; const v: PGLfloat); stdcall;
  glVertexAttribs1dvNV: procedure(index: GLuint; n: GLsizei; const v: PGLdouble); stdcall;
  glVertexAttribs2svNV: procedure(index: GLuint; n: GLsizei; const v: PGLshort); stdcall;
  glVertexAttribs2fvNV: procedure(index: GLuint; n: GLsizei; const v: PGLfloat); stdcall;
  glVertexAttribs2dvNV: procedure(index: GLuint; n: GLsizei; const v: PGLdouble); stdcall;
  glVertexAttribs3svNV: procedure(index: GLuint; n: GLsizei; const v: PGLshort); stdcall;
  glVertexAttribs3fvNV: procedure(index: GLuint; n: GLsizei; const v: PGLfloat); stdcall;
  glVertexAttribs3dvNV: procedure(index: GLuint; n: GLsizei; const v: PGLdouble); stdcall;
  glVertexAttribs4svNV: procedure(index: GLuint; n: GLsizei; const v: PGLshort); stdcall;
  glVertexAttribs4fvNV: procedure(index: GLuint; n: GLsizei; const v: PGLfloat); stdcall;
  glVertexAttribs4dvNV: procedure(index: GLuint; n: GLsizei; const v: PGLdouble); stdcall;
  glVertexAttribs4ubvNV: procedure(index: GLuint; n: GLsizei; const v: PGLubyte); stdcall;
...
var
  glElementPointerATI: procedure(_type: GLenum; const pointer: PGLvoid); stdcall;
...
var
  glTexBumpParameterivATI: procedure(pname: GLenum; param: PGLint); stdcall;
  glTexBumpParameterfvATI: procedure(pname: GLenum; param: PGLfloat); stdcall;
...
var
  glNewObjectBufferATI: function(size: GLsizei; const pointer: PGLvoid; usage: GLenum): GLuint; stdcall;
  glIsObjectBufferATI: function(buffer: GLuint): GLboolean; stdcall;
  glUpdateObjectBufferATI: procedure(buffer: GLuint; offset: GLuint; size: GLsizei; const pointer: PGLvoid; preserve: GLenum); stdcall;
  ...
  glDeleteObjectBufferATI: procedure(buffer: GLuint); stdcall;
...
var
  glVertexStream1s: procedure(stream: GLenum; coords: GLshort); stdcall;
  glVertexStream1i: procedure(stream: GLenum; coords: GLint); stdcall;
  glVertexStream1f: procedure(stream: GLenum; coords: GLfloat); stdcall;
  glVertexStream1d: procedure(stream: GLenum; coords: GLdouble); stdcall;
  glVertexStream1sv: procedure(stream: GLenum; coords: GLshort); stdcall;
  glVertexStream1iv: procedure(stream: GLenum; coords: GLint); stdcall;
  glVertexStream1fv: procedure(stream: GLenum; coords: GLfloat); stdcall;
  glVertexStream1dv: procedure(stream: GLenum; coords: GLdouble); stdcall;
  glVertexStream2s: procedure(stream: GLenum; coords: GLshort); stdcall;
  glVertexStream2i: procedure(stream: GLenum; coords: GLint); stdcall;
  glVertexStream2f: procedure(stream: GLenum; coords: GLfloat); stdcall;
  glVertexStream2d: procedure(stream: GLenum; coords: GLdouble); stdcall;
  glVertexStream2sv: procedure(stream: GLenum; coords: GLshort); stdcall;
  glVertexStream2iv: procedure(stream: GLenum; coords: GLint); stdcall;
  glVertexStream2fv: procedure(stream: GLenum; coords: GLfloat); stdcall;
  glVertexStream2dv: procedure(stream: GLenum; coords: GLdouble); stdcall;
  glVertexStream3s: procedure(stream: GLenum; coords: GLshort); stdcall;
  glVertexStream3i: procedure(stream: GLenum; coords: GLint); stdcall;
  glVertexStream3f: procedure(stream: GLenum; coords: GLfloat); stdcall;
  glVertexStream3d: procedure(stream: GLenum; coords: GLdouble); stdcall;
  glVertexStream3sv: procedure(stream: GLenum; coords: GLshort); stdcall;
  glVertexStream3iv: procedure(stream: GLenum; coords: GLint); stdcall;
  glVertexStream3fv: procedure(stream: GLenum; coords: GLfloat); stdcall;
  glVertexStream3dv: procedure(stream: GLenum; coords: GLdouble); stdcall;
  glVertexStream4s: procedure(stream: GLenum; coords: GLshort); stdcall;
  glVertexStream4i: procedure(stream: GLenum; coords: GLint); stdcall;
  glVertexStream4f: procedure(stream: GLenum; coords: GLfloat); stdcall;
  glVertexStream4d: procedure(stream: GLenum; coords: GLdouble); stdcall;
  glVertexStream4sv: procedure(stream: GLenum; coords: GLshort); stdcall;
  glVertexStream4iv: procedure(stream: GLenum; coords: GLint); stdcall;
  glVertexStream4fv: procedure(stream: GLenum; coords: GLfloat); stdcall;
  glVertexStream4dv: procedure(stream: GLenum; coords: GLdouble); stdcall;
  glNormalStream3b: procedure(stream: GLenum; coords: GLbyte); stdcall;
  glNormalStream3s: procedure(stream: GLenum; coords: GLshort); stdcall;
  glNormalStream3i: procedure(stream: GLenum; coords: GLint); stdcall;
  glNormalStream3f: procedure(stream: GLenum; coords: GLfloat); stdcall;
  glNormalStream3d: procedure(stream: GLenum; coords: GLdouble); stdcall;
  glNormalStream3bv: procedure(stream: GLenum; coords: GLbyte); stdcall;
  glNormalStream3sv: procedure(stream: GLenum; coords: GLshort); stdcall;
  glNormalStream3iv: procedure(stream: GLenum; coords: GLint); stdcall;
  glNormalStream3fv: procedure(stream: GLenum; coords: GLfloat); stdcall;
  glNormalStream3dv: procedure(stream: GLenum; coords: GLdouble); stdcall;
  glClientActiveVertexStream: procedure(stream: GLenum); stdcall;
  glVertexBlendEnvi: procedure(pname: GLenum; param: GLint); stdcall;
  glVertexBlendEnvf: procedure(pname: GLenum; param: GLfloat); stdcall;
...
var
  wglCreateImageBufferI3D: function(hDC: HDC; dwSize: DWORD; uFlags: UINT): PGLvoid; stdcall;
  wglDestroyImageBufferI3D: function(hDC: HDC; pAddress: PGLvoid): BOOL; stdcall;
  wglAssociateImageBufferEventsI3D: function(hdc: HDC; pEvent: PHandle; pAddress: PGLvoid; pSize: PDWORD; count: UINT): BOOL; stdcall;
  wglReleaseImageBufferEventsI3D: function(hdc: HDC; pAddress: PGLvoid; count: UINT): BOOL; stdcall;

function Load_WGL_I3D_image_buffer: Boolean;

//***** WGL_I3D_swap_frame_lock *****//
var
  wglEnableFrameLockI3D: function(): BOOL; stdcall;
  wglDisableFrameLockI3D: function(): BOOL; stdcall;
  wglIsEnabledFrameLockI3D: function(pFlag: PBOOL): BOOL; stdcall;
  wglQueryFrameLockMasterI3D: function(pFlag: PBOOL): BOOL; stdcall;

function Load_WGL_I3D_swap_frame_lock: Boolean;

//***** WGL_I3D_swap_frame_usage *****//
var
  wglGetFrameUsageI3D: function(pUsage: PGLfloat): BOOL; stdcall;
  wglBeginFrameTrackingI3D: function(): BOOL; stdcall;
  wglEndFrameTrackingI3D: function(): BOOL; stdcall;
  wglQueryFrameTrackingI3D: function(pFrameCount: PDWORD; pMissedFrames: PDWORD; pLastMissedUsage: PGLfloat): BOOL; stdcall;
...
var
  glMultiModeDrawArraysIBM: procedure(mode: PGLenum; first: PGLint; count: PGLsizei; primcount: GLsizei; modestride: GLint); stdcall;
  glMultiModeDrawElementsIBM: procedure(mode: PGLenum; count: PGLsizei; _type: GLenum; const indices: PGLvoid; primcount: GLsizei; modestride: GLint); stdcall;
...
var
  glColorPointerListIBM: procedure(size: GLint; _type: GLenum; stride: GLint; const pointer: PGLvoid; ptrstride: GLint); stdcall;
  glSecondaryColorPointerListIBM: procedure(size: GLint; _type: GLenum; stride: GLint; const pointer: PGLvoid; ptrstride: GLint); stdcall;
  glEdgeFlagPointerListIBM: procedure(stride: GLint; const pointer: PGLboolean; ptrstride: GLint); stdcall;
  glFogCoordPointerListIBM: procedure(_type: GLenum; stride: GLint; const pointer: PGLvoid; ptrstride: GLint); stdcall;
  glNormalPointerListIBM: procedure(_type: GLenum; stride: GLint; const pointer: PGLvoid; ptrstride: GLint); stdcall;
  glTexCoordPointerListIBM: procedure(size: GLint; _type: GLenum; stride: GLint; const pointer: PGLvoid; ptrstride: GLint); stdcall;
  glVertexPointerListIBM: procedure(size: GLint; _type: GLenum; stride: GLint; const pointer: PGLvoid; ptrstride: GLint); stdcall;
...
var
  ...
  glWindowPos2ivMESA: procedure(const p: PGLint); stdcall;
  glWindowPos2svMESA: procedure(const p: PGLshort); stdcall;
  glWindowPos2fvMESA: procedure(const p: PGLfloat); stdcall;
  glWindowPos2dvMESA: procedure(const p: PGLdouble); stdcall;
  ...
  glWindowPos3ivMESA: procedure(const p: PGLint); stdcall;
  glWindowPos3svMESA: procedure(const p: PGLshort); stdcall;
  glWindowPos3fvMESA: procedure(const p: PGLfloat); stdcall;
  glWindowPos3dvMESA: procedure(const p: PGLdouble); stdcall;
  ...
  glWindowPos4ivMESA: procedure(const p: PGLint); stdcall;
  glWindowPos4svMESA: procedure(const p: PGLshort); stdcall;
  glWindowPos4fvMESA: procedure(const p: PGLfloat); stdcall;
  glWindowPos4dvMESA: procedure(const p: PGLdouble); stdcall;
...
var
  ...
  glGetPixelTexGenParameterivSGIS: procedure(pname: GLenum; params: GLint); stdcall;
  glGetPixelTexGenParameterfvSGIS: procedure(pname: GLenum; params: GLfloat); stdcall;
...
var
  glTextureColorMaskSGIS: procedure(r: GLboolean; g: GLboolean; b: GLboolean; a: GLboolean); stdcall;
...
var
  glColorTableSGI: procedure(target: GLenum; internalformat: GLenum; width: GLsizei; format: GLenum; _type: GLenum; const table: PGLvoid); stdcall;
  ...
  glGetColorTableSGI: procedure(target: GLenum; format: GLenum; _type: GLenum; table: PGLvoid); stdcall;
...
var
     ...
     glGetBufferSubDataARB : procedure(target : GLenum; offset :GLint; size : GLsizei; data: PGLvoid); stdcall;
     ...
     glGetBufferPointervARB : procedure(target: GLenum; pname:GLenum; params: PPGLvoid); stdcall;
...
var
  glElementPointerAPPLE: procedure(_type: GLenum; const pointer: PGLvoid); stdcall;
...
var
  ...
  glGenVertexArraysAPPLE: procedure(n: GLsizei; const arrays: PGLuint); stdcall;
  glIsVertexArrayAPPLE: function(_array: GLuint): GLboolean; stdcall;
...
var
  glVertexArrayRangeAPPLE: procedure(length: GLsizei; pointer: PGLvoid); stdcall;
  glFlushVertexArrayRangeAPPLE: procedure(length: GLsizei; pointer: PGLvoid); stdcall;
...
var
  wglMakeContextCurrentARB: function(hDrawDC: HDC; hReadDC: HDC; hglrc: HGLRC): BOOL; stdcall;
...
var
  ...
  wglQueryPbufferARB: function(hPbuffer: THandle; iAttribute: GLint; piValue: PGLint): BOOL; stdcall;
...
const
  ...
  WGL_AUX9_ARB = $2090;
var
  wglBindTexImageARB: function(hPbuffer: THandle; iBuffer: GLint): BOOL; stdcall;
  wglReleaseTexImageARB: function(hPbuffer: THandle; iBuffer: GLint): BOOL; stdcall;
  wglSetPbufferAttribARB: function(hPbuffer: THandle; const piAttribList: PGLint): BOOL; stdcall;
...
var
  wglMakeContextCurrentEXT: function(hDrawDC: HDC; hReadDC: HDC; hglrc: HGLRC): BOOL; stdcall;
...
var
  wglCreatePbufferEXT: function(hDC: HDC; iPixelFormat: GLint; iWidth: GLint; iHeight: GLint; const piAttribList: PGLint): THandle; stdcall;
  wglGetPbufferDCEXT: function(hPbuffer: THandle): HDC; stdcall;
  wglReleasePbufferDCEXT: function(hPbuffer: THandle; hDC: HDC): GLint; stdcall;
  wglDestroyPbufferEXT: function(hPbuffer: THandle): BOOL; stdcall;
  wglQueryPbufferEXT: function(hPbuffer: THandle; iAttribute: GLint; piValue: PGLint): BOOL; stdcall;
...
var
  wglGetPixelFormatAttribivEXT: function(hdc: HDC; iPixelFormat: GLint; iLayerPlane: GLint; nAttributes: GLuint; piAttributes: PGLint; piValues: PGLint): BOOL; stdcall;
  wglGetPixelFormatAttribfvEXT: function(hdc: HDC; iPixelFormat: GLint; iLayerPlane: GLint; nAttributes: GLuint; piAttributes: PGLint; pfValues: PGLfloat): BOOL; stdcall;
  wglChoosePixelFormatEXT: function(hdc: HDC; const piAttribIList: PGLint; const pfAttribFList: PGLfloat; nMaxFormats: GLuint; piFormats: PGLint; nNumFormats: PGLuint): BOOL; stdcall;
...
var
  wglGetDigitalVideoParametersI3D: function(hDC: HDC; iAttribute: GLint; piValue: PGLint): BOOL; stdcall;
  wglSetDigitalVideoParametersI3D: function(hDC: HDC; iAttribute: GLint; const piValue: PGLint): BOOL; stdcall;
...
var
  wglGetGammaTableParametersI3D: function(hDC: HDC; iAttribute: GLint; piValue: PGLint): BOOL; stdcall;
  wglSetGammaTableParametersI3D: function(hDC: HDC; iAttribute: GLint; const piValue: PGLint): BOOL; stdcall;
  wglGetGammaTableI3D: function(hDC: HDC; iEntries: GLint; puRed: PGLUSHORT; puGreen: PGLUSHORT; puBlue: PGLUSHORT): BOOL; stdcall;
  wglSetGammaTableI3D: function(hDC: HDC; iEntries: GLint; const puRed: PGLUSHORT; const puGreen: PGLUSHORT; const puBlue: PGLUSHORT): BOOL; stdcall;
...
var
  wglEnableGenlockI3D: function(hDC: HDC): BOOL; stdcall;
  wglDisableGenlockI3D: function(hDC: HDC): BOOL; stdcall;
  wglIsEnabledGenlockI3D: function(hDC: HDC; pFlag: PBOOL): BOOL; stdcall;
  wglGenlockSourceI3D: function(hDC: HDC; uSource: GLUINT): BOOL; stdcall;
  wglGetGenlockSourceI3D: function(hDC: HDC; uSource: PGLUINT): BOOL; stdcall;
  wglGenlockSourceEdgeI3D: function(hDC: HDC; uEdge: GLUINT): BOOL; stdcall;
  wglGetGenlockSourceEdgeI3D: function(hDC: HDC; uEdge: PGLUINT): BOOL; stdcall;
  wglGenlockSampleRateI3D: function(hDC: HDC; uRate: GLUINT): BOOL; stdcall;
  wglGetGenlockSampleRateI3D: function(hDC: HDC; uRate: PGLUINT): BOOL; stdcall;
  wglGenlockSourceDelayI3D: function(hDC: HDC; uDelay: GLUINT): BOOL; stdcall;
  wglGetGenlockSourceDelayI3D: function(hDC: HDC; uDelay: PGLUINT): BOOL; stdcall;
  wglQueryGenlockMaxSourceDelayI3D: function(hDC: HDC; uMaxLineDelay: PGLUINT; uMaxPixelDelay: PGLUINT): BOOL; stdcall;
...
var
  ...
  glMatrixIndexubvARB: procedure(size: GLint; indices: PGLubyte); stdcall;
  glMatrixIndexusvARB: procedure(size: GLint; indices: PGLushort); stdcall;
  glMatrixIndexuivARB: procedure(size: GLint; indices: PGLuint); stdcall;
  glMatrixIndexPointerARB: procedure(size: GLint; _type: GLenum; stride: GLsizei; pointer: PGLvoid); stdcall;
...
var
  glElementPointerNV: procedure(_type: GLenum; const pointer: PGLvoid); stdcall;
  glDrawElementArrayNV: procedure(mode: GLenum; first: GLint; count: GLsizei); stdcall;
  glDrawRangeElementArrayNV: procedure(mode: GLenum; start: GLuint; _end: GLuint; first: GLint; count: GLsizei); stdcall;
  glMultiDrawElementArrayNV: procedure(mode: GLenum; const first: PGLint; const count: PGLsizei; primcount: GLsizei); stdcall;
  glMultiDrawRangeElementArrayNV: procedure(mode: GLenum; start: GLuint; _end: GLuint; const first: PGLint; const count: PGLsizei; primcount: GLsizei); stdcall;
...
var
  glPixelDataRangeNV: procedure(target: GLenum; length: GLsizei; pointer: PGLvoid); stdcall;
...
var
  glVertex2hNV: procedure(x: GLushort; y: GLushort); stdcall;
  glVertex2hvNV: procedure(const v: PGLushort); stdcall;
  glVertex3hNV: procedure(x: GLushort; y: GLushort; z: GLushort); stdcall;
  glVertex3hvNV: procedure(const v: PGLushort); stdcall;
  glVertex4hNV: procedure(x: GLushort; y: GLushort; z: GLushort; w: GLushort); stdcall;
  glVertex4hvNV: procedure(const v: PGLushort); stdcall;
  glNormal3hNV: procedure(nx: GLushort; ny: GLushort; nz: GLushort); stdcall;
  glNormal3hvNV: procedure(const v: PGLushort); stdcall;
  glColor3hNV: procedure(red: GLushort; green: GLushort; blue: GLushort); stdcall;
  glColor3hvNV: procedure(const v: PGLushort); stdcall;
  glColor4hNV: procedure(red: GLushort; green: GLushort; blue: GLushort; alpha: GLushort); stdcall;
  glColor4hvNV: procedure(const v: PGLushort); stdcall;
  glTexCoord1hNV: procedure(s: GLushort); stdcall;
  glTexCoord1hvNV: procedure(const v: PGLushort); stdcall;
  glTexCoord2hNV: procedure(s: GLushort; t: GLushort); stdcall;
  glTexCoord2hvNV: procedure(const v: PGLushort); stdcall;
  glTexCoord3hNV: procedure(s: GLushort; t: GLushort; r: GLushort); stdcall;
  glTexCoord3hvNV: procedure(const v: PGLushort); stdcall;
  glTexCoord4hNV: procedure(s: GLushort; t: GLushort; r: GLushort; q: GLushort); stdcall;
  glTexCoord4hvNV: procedure(const v: PGLushort); stdcall;
  glMultiTexCoord1hNV: procedure(target: GLenum; s: GLushort); stdcall;
  glMultiTexCoord1hvNV: procedure(target: GLenum; const v: PGLushort); stdcall;
  glMultiTexCoord2hNV: procedure(target: GLenum; s: GLushort; t: GLushort); stdcall;
  glMultiTexCoord2hvNV: procedure(target: GLenum; const v: PGLushort); stdcall;
  glMultiTexCoord3hNV: procedure(target: GLenum; s: GLushort; t: GLushort; r: GLushort); stdcall;
  glMultiTexCoord3hvNV: procedure(target: GLenum; const v: PGLushort); stdcall;
  glMultiTexCoord4hNV: procedure(target: GLenum; s: GLushort; t: GLushort; r: GLushort; q: GLushort); stdcall;
  glMultiTexCoord4hvNV: procedure(target: GLenum; const v: PGLushort); stdcall;
  glFogCoordhNV: procedure(fog: GLushort); stdcall;
  glFogCoordhvNV: procedure(const fog: PGLushort); stdcall;
  glSecondaryColor3hNV: procedure(red: GLushort; green: GLushort; blue: GLushort); stdcall;
  glSecondaryColor3hvNV: procedure(const v: PGLushort); stdcall;
  glVertexWeighthNV: procedure(weight: GLushort); stdcall;
  glVertexWeighthvNV: procedure(const weight: PGLushort); stdcall;
  glVertexAttrib1hNV: procedure(index: GLuint; x: GLushort); stdcall;
  glVertexAttrib1hvNV: procedure(index: GLuint; const v: PGLushort); stdcall;
  glVertexAttrib2hNV: procedure(index: GLuint; x: GLushort; y: GLushort); stdcall;
  glVertexAttrib2hvNV: procedure(index: GLuint; const v: PGLushort); stdcall;
  glVertexAttrib3hNV: procedure(index: GLuint; x: GLushort; y: GLushort; z: GLushort); stdcall;
  glVertexAttrib3hvNV: procedure(index: GLuint; const v: PGLushort); stdcall;
  glVertexAttrib4hNV: procedure(index: GLuint; x: GLushort; y: GLushort; z: GLushort; w: GLushort); stdcall;
  glVertexAttrib4hvNV: procedure(index: GLuint; const v: PGLushort); stdcall;
  glVertexAttribs1hvNV: procedure(index: GLuint; n: GLsizei; const v: PGLushort); stdcall;
  glVertexAttribs2hvNV: procedure(index: GLuint; n: GLsizei; const v: PGLushort); stdcall;
  glVertexAttribs3hvNV: procedure(index: GLuint; n: GLsizei; const v: PGLushort); stdcall;
  glVertexAttribs4hvNV: procedure(index: GLuint; n: GLsizei; const v: PGLushort); stdcall;

function Load_GL_NV_half_float: Boolean;

//***** GL_ATI_map_object_buffer *****//
var
  glMapObjectBufferATI: function(buffer: GLuint): PGLvoid; stdcall;
...
var
  glMapBufferRange: function(target: GLenum; offset: GLintptr; length: GLsizeiptr; access: GLbitfield): PGLvoid; stdcall;
...
var
  glDrawElementsBaseVertex: procedure(mode: GLenum; count: GLsizei; _type: GLenum; const indices: PGLvoid; basevertex: GLint); stdcall;
  glDrawRangeElementsBaseVertex: procedure(mode: GLenum; start: GLuint; _end: GLuint; count: GLsizei; _type: GLenum; const indices: PGLvoid; basevertex: GLint); stdcall;
  glDrawElementsInstancedBaseVertex: procedure(mode: GLenum; count: GLsizei; _type: GLenum; const indices: PGLvoid; primcount: GLsizei; basevertex: GLint); stdcall;
  glMultiDrawElementsBaseVertex: procedure(mode: GLenum; const count: PGLsizei; _type: GLenum; const indices: PPGLvoid; primcount: GLsizei; const basevertex: PGLint); stdcall;
...
var
  ...
  glGetInteger64v: procedure(pname: GLenum; params: PGLint64); stdcall;
...
var
  glTexImage2DMultisample: procedure(target: GLenum; samples: GLsizei; internalformat: GLint; width: GLsizei; height: GLsizei; fixedsamplelocations: GLboolean); stdcall;
  glTexImage3DMultisample: procedure(target: GLenum; samples: GLsizei; internalformat: GLint; width: GLsizei; height: GLsizei; depth: GLsizei; fixedsamplelocations: GLboolean); stdcall;
...
var
  ...
  glBindSampler: procedure(_unit: GLenum; sampler: GLuint); stdcall;
...
var
  ...
  glFogCoordPointer: procedure(_type: GLenum; stride: GLsizei; const pointer: PGLvoid); stdcall;
  glMultiDrawArrays: procedure(mode: GLenum; first: PGLint; count: PGLsizei; primcount: GLsizei); stdcall;
  glMultiDrawElements: procedure(mode: GLenum; const count: PGLsizei; _type: GLenum; const indices: PGLvoid; primcount: GLsizei); stdcall;
  ...
  glSecondaryColorPointer: procedure(size: GLint; _type: GLenum; stride: GLsizei; const pointer: PGLvoid); stdcall;
...
var
  ...
  glBufferData: procedure(target: GLenum; size: GLsizeiptr; const data: PGLvoid; usage: GLenum); stdcall;
  glBufferSubData: procedure(target: GLenum; offset: GLintptr; size: GLsizeiptr; const data: PGLvoid); stdcall;
  glGetBufferSubData: procedure(target: GLenum; offset: GLintptr; size: GLsizeiptr; data: PGLvoid); stdcall;
  ...
  glGetBufferPointerv: procedure(target: GLenum; pname: GLenum; params: PGLvoid); stdcall;
...
var
  ...
  glStencilFuncSeparate: procedure(frontfunc: GLenum; backfunc: GLenum; ref: GLint; mask: GLuint); stdcall;
  ...
  glGetAttachedShaders: procedure(_program: GLuint; maxCount: GLsizei; count: PGLsizei; obj: PGLuint); stdcall;
  ...
  glGetVertexAttribPointerv: procedure(index: GLuint; pname: GLenum; pointer: PGLvoid); stdcall;
  ...
  glShaderSource: procedure(shader: GLuint; count: GLsizei; const _string: PGLchar; const length: PGLint); stdcall;
  ...
  glVertexAttribPointer: procedure(index: GLuint; size: GLint; _type: GLenum; normalized: GLboolean; stride: GLsizei; const pointer: PGLvoid); stdcall;
...
var
  ...
  glGetIntegeri_v: procedure(target: GLenum; index: GLuint; data: PGLint); stdcall; (* Also used in GL_ARB_uniform_buffer_object *)
  ...
  glBindBufferRange: procedure(target: GLenum; index: GLuint; buffer: GLuint; offset: GLintptr; size: GLsizeiptr); stdcall; (* Also used in GL_ARB_uniform_buffer_object *)
  glBindBufferBase: procedure(target: GLenum; index: GLuint; buffer: GLuint); stdcall; (* Also used in GL_ARB_uniform_buffer_object *)
  ...
  glVertexAttribIPointer: procedure(index: GLuint; size: GLint; _type: GLenum; stride: GLsizei; const _pointer: PGLvoid); stdcall;
...
var
  glDrawArraysInstanced: procedure(mode: GLenum; first: GLint; count: GLsizei; primcount: GLsizei); stdcall;
  glDrawElementsInstanced: procedure(mode: GLenum; count: GLsizei; _type: GLenum; const indices: PGLvoid; primcount: GLsizei); stdcall;
...
type
  GLDEBUGPROC = procedure (source:GLenum; _type:GLenum; id:GLuint; severity:GLenum; length:GLsizei; message:PGLchar; userParam:PGLvoid );stdcall;
