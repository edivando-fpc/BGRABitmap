...
uses classes, FPImage, FPCanvas, Types;

procedure DrawSolidEllipse (Canv:TFPCustomCanvas; const Bounds:TRect; c:TFPColor); overload;
procedure DrawSolidEllipse (Canv:TFPCustomCanvas; const Bounds:TRect; Width:integer; c:TFPColor); overload;
...
type
  ...
  public
    ...
    function GetInfoForX (x:integer; var ytopmax,ytopmin,ybotmax,ybotmin:integer):boolean; overload;
    function GetInfoForX (x:integer; var Info:PEllipseInfoData):boolean; overload;
