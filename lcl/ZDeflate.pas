...
type
  Tcompress_func = function(var s : deflate_state; flush : integer) : block_state;
...
type
  ...
  Tconfiguration_table = array[0..10-1] of config;

{local}
var
  configuration_table : Tconfiguration_table = (
...
{$else}
  ...
  ds^.pending_out := @ds^.pending_buf^[DWord(ss^.pending_out) - DWord(ss^.pending_buf)];
