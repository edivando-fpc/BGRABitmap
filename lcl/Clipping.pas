...
procedure SortRect (var rect : TRect); overload;
procedure SortRect (var left,top, right,bottom : integer); overload;
...
procedure CheckRectClipping (ClipRect:TRect; var x1,y1, x2,y2 : integer); overload;
