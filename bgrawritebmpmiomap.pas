...
uses
  ...
  FPImage, BGRABitmapTypes, BGRAReadBmpMioMap;
...
type
  ...
  protected
    ...
    FPaletteIndexes: packed array[0..65535] of BGRANativeInt;
    FPaletteOffset: BGRANativeInt;
    FPaletteAlpha: boolean;
    FChunks: array of TMemoryStream;
    FCurrentChunk: TMemoryStream;
    FMaxChunkSize: BGRAWord;
    function IndexOfColor(const AColor: TBGRAPixel): BGRANativeInt;
  ...
  public
    ...
    property MaxChunkSize: BGRAWord read FMaxChunkSize write FMaxChunkSize;
  end;
...
var searchedColorValue: BGRAWord;
  ...
  i,startSearch,endSearch: BGRANativeInt;
begin
...
begin
  ...
  begin
    ...
    FCurrentChunk := nil;
    FHeader.nbChunks := FHeader.nbChunks +1;
  end;
end;
...
var y,w: BGRANativeInt;
  PData,PDataEnd: PBGRAPixel;
  p: PBGRAPixel;
  currentColorIndex,
  nextColorIndex,
  repCount: BGRANativeInt;
  b: byte;
...
var
  colors: packed array of BGRAWord;
