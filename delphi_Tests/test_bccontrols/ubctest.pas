...
uses
  ...
  StdCtrls, types, ExtCtrls,
  BCButton, BCLabel, BCPanel, BGRAShape, BCSamples, BCBaseCtrls;
...
procedure TForm1.ListDrawItem(Control: TWinControl; Index: integer;
  ARect: TRect; State: TOwnerDrawState);
begin
  DrawItem(Control, Index, ARect, State, StrToTBCSampleDrawing(ComboBox1.Text));
end;

procedure TForm1.ListBox1Click(Sender: TObject);
begin
  StyleButtonsSample(Self, StrToTBCSampleStyle(ListBox1.Items[ListBox1.ItemIndex]));
end;
