...
uses
  ...
  BCFilters, BGRATextFX, Types, BCBaseCtrls, Vcl.ExtCtrls;
...
begin
  ...
  { Strings }
  str := TBGRAGraphicCtrl(Sender).Caption;
...
begin
  ...
  Image := TBGRABitmap.Create(ExtractFilePath(Application.ExeName) + '\' +  'back5.jpg');
end;
